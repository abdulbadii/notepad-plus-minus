...
#define	IDD_PREFERENCE_SETTING_BOX 6300 //(IDD_PREFERENCE_BOX + 300)
	...
	#define	IDC_MAXNBFILEVAL_STATIC (IDD_PREFERENCE_SETTING_BOX + 7)
	#define	IDC_MAXNBFIND_STATIC (IDD_PREFERENCE_SETTING_BOX + 48)
	#define	IDC_MAXNBFINDVAL_STATIC (IDD_PREFERENCE_SETTING_BOX + 49)
...
#define	IDD_PREFERENCE_BACKUP_BOX 6800 //(IDD_PREFERENCE_BOX + 800)
	...
	#define IDD_AUTOC_IGNORECASE  (IDD_PREFERENCE_BACKUP_BOX + 25)
