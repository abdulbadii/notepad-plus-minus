...
SecurityGard::SecurityGard()
{
	...
	_pluginListSha256.push_back(L"be9e251a30fd712fd2ff98febd360805df51110b6659de8c9a0000220d7ae535"); // v1.0.7 32 bit (unsigned)
	_pluginListSha256.push_back(L"3ecd7f9c56bcd659a4126c659eb69b354789c78574a82390749ac751ae539bc6"); // v1.0.7 64 bit (unsigned)
...
bool SecurityGard::verifySignedLibrary(const std::wstring& filepath, NppModule module2check)
{
	...
	try {
		...
		if (module2check == nm_scilexer)
			::MessageBox(NULL, s.c_str(), L"DLL signature verification failed", MB_ICONERROR);
