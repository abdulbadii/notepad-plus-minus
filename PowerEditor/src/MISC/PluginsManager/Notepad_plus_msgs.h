...
#define NPPMSG  (WM_USER + 1000)
	...
	#define NPPM_SETSTATUSBAR (NPPMSG + 24)
		...
		#define STATUSBAR_CR_UZ 3
		#define STATUSBAR_INFOS 4
		#define STATUSBAR_DOC_SIZE 5
		#define STATUSBAR_EOF_FORMAT 6
		#define STATUSBAR_ENCODING 7
		#define STATUSBAR_SEL_PASTE 8
		#define STATUSBAR_SEL_UNDO 9
