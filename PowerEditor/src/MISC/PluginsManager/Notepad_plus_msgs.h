...
#define NPPMSG  (WM_USER + 1000)
	...
	enum { MAIN_VIEW, SUB_VIEW };

#define NPPM_SETSTATUSBAR (NPPMSG + 24)
/* 
#define STATUSBAR_DOC_TYPE 0
#define STATUSBAR_DOC_NAME 1
#define STATUSBAR_CUR_POS 2
#define STATUSBAR_INFOS 3
#define STATUSBAR_DOC_SIZE 4
#define STATUSBAR_EOF_FORMAT 5
#define STATUSBAR_ENCODING 6
#define STATUSBAR_SEL_PASTE 7
#define STATUSBAR_SEL_UNDO 8
#define STATUSBAR_CR_UZ 9
#define STATUSBAR_TYPING_MODE 10
 */
enum { STATUSBAR_DOC_TYPE,
	STATUSBAR_DOC_NAME,
	STATUSBAR_CUR_POS,
	STATUSBAR_INFOS,
	STATUSBAR_DOC_SIZE,
	...
	#define NPPM_DMMREGASDCKDLG_N (NPPMSG + 99)
