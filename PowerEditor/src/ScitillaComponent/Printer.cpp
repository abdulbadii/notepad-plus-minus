...
*/
	...
	TCHAR headerL[headerSize] = L"";
	TCHAR headerM[headerSize] = L"";
	TCHAR headerR[headerSize] = L"";
	TCHAR footerL[headerSize] = L"";
	TCHAR footerM[headerSize] = L"";
	TCHAR footerR[headerSize] = L"";
	

	const TCHAR shortDateVar[] = L"$(SHORT_DATE)";
	const TCHAR longDateVar[] = L"$(LONG_DATE)";
	const TCHAR timeVar[] = L"$(TIME)";
