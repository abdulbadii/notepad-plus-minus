...
#define NOTEPAD_PLUS_VERSION L"Notepad++ v7.8.3    Notepad+- 0.0.1"

// should be X.Y : ie. if VERSION_DIGITALVALUE == 4, 7, 1, 0 , then X = 4, Y = 71
// ex : #define VERSION_VALUE L"5.63\0"
#define VERSION_VALUE L"7.83\0"
...
#define NOTEPADPLUS_USER_INTERNAL     (WM_USER + 0000)
	...
	#define NPPM_INTERNAL_KEYMODIFIED      (NOTEPADPLUS_USER_INTERNAL + 7)
	#define NPPM_INTERNAL_FINFERCOLLAPSE   (NOTEPADPLUS_USER_INTERNAL + 8)
	#define NPPM_INTERNAL_FINFERUNCOLLAPSE (NOTEPADPLUS_USER_INTERNAL + 9)
	...
	#define NPPM_INTERNAL_FINFERCOPY       (NOTEPADPLUS_USER_INTERNAL + 16)
	#define NPPM_INTERNAL_FINFERSELECTALL  (NOTEPADPLUS_USER_INTERNAL + 17)
	...
	#define NPPM_INTERNAL_FINFERCLEARALL   (NOTEPADPLUS_USER_INTERNAL + 27)
	...
	#define NPPM_INTERNAL_FINFEROPENALL    (NOTEPADPLUS_USER_INTERNAL + 34)
